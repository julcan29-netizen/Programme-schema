...
def svg_command():
    return (
        ...
        '<line x1="90" y1="120" x2="90" y2="520" stroke="#111" stroke-width="2"/>'
        '<line x1="1010" y1="120" x2="1010" y2="520" stroke="#111" stroke-width="2"/>'
        '<text x="82" y="112" font-size="11" fill="#111">L</text>'
        '<text x="1002" y="112" font-size="11" fill="#111">N</text>'

        '<text x="120" y="150" font-size="12" fill="#111">Alimentation régulation 24V~</text>'
        '<line x1="90" y1="165" x2="300" y2="165" stroke="#111" stroke-width="1.5"/>'
        '<line x1="300" y1="165" x2="300" y2="205" stroke="#111" stroke-width="1.5"/>'
        '<line x1="300" y1="205" x2="340" y2="205" stroke="#111" stroke-width="1.5"/>'
        '<line x1="760" y1="205" x2="1010" y2="205" stroke="#111" stroke-width="1.5"/>'

        '<rect x="340" y="170" width="420" height="170" fill="none" stroke="#111" stroke-width="1.5"/>'
        '<text x="360" y="195" font-size="13" fill="#111">A1 MPX PRO</text>'
        '<text x="360" y="220" font-size="11" fill="#111">Régulation température batterie / reprise</text>'
        '<text x="360" y="240" font-size="11" fill="#111">Commande vanne 3 voies modulante</text>'
        '<text x="360" y="260" font-size="11" fill="#111">Alimentation 24V~</text>'

        '<circle cx="200" cy="255" r="5" fill="none" stroke="#111" stroke-width="1.4"/>'
        '<line x1="200" y1="260" x2="200" y2="285" stroke="#111" stroke-width="1.4"/>'
        '<line x1="205" y1="255" x2="340" y2="255" stroke="#111" stroke-width="1.4"/>'
        '<text x="215" y="250" font-size="11" fill="#111">TT1 Entrée batterie</text>'

        '<circle cx="200" cy="315" r="5" fill="none" stroke="#111" stroke-width="1.4"/>'
        '<line x1="200" y1="320" x2="200" y2="345" stroke="#111" stroke-width="1.4"/>'
        '<line x1="205" y1="315" x2="340" y2="315" stroke="#111" stroke-width="1.4"/>'
        '<text x="215" y="310" font-size="11" fill="#111">TT2 Reprise</text>'

        '<text x="610" y="255" font-size="11" fill="#111">AO+</text>'
        '<text x="610" y="285" font-size="11" fill="#111">AO-</text>'
        '<line x1="760" y1="255" x2="840" y2="255" stroke="#111" stroke-width="1.5"/>'
        '<line x1="760" y1="285" x2="840" y2="285" stroke="#111" stroke-width="1.5"/>'

        '<circle cx="840" cy="255" r="4" fill="none" stroke="#111" stroke-width="1.4"/>'
        '<circle cx="840" cy="285" r="4" fill="none" stroke="#111" stroke-width="1.4"/>'
        '<text x="852" y="259" font-size="11" fill="#111">Vers YV1 AO+</text>'
        '<text x="852" y="289" font-size="11" fill="#111">Vers YV1 AO-</text>'

        '<text x="120" y="385" font-size="12" fill="#111">Fonctionnement de référence</text>'
        '<text x="140" y="415" font-size="11" fill="#111">• Pompe de circulation : fonctionnement permanent</text>'
        '<text x="140" y="438" font-size="11" fill="#111">• Ventilation : fonctionnement permanent</text>'
        '<text x="140" y="461" font-size="11" fill="#111">• Régulation : modulation YV1 selon température</text>'
        '<text x="140" y="484" font-size="11" fill="#111">• Dégivrage : naturel</text>'

        '<text x="620" y="385" font-size="12" fill="#111">Consignes extraites</text>'
        '<text x="640" y="415" font-size="11" fill="#111">• Consigne vanne : +4°C</text>'
        '<text x="640" y="438" font-size="11" fill="#111">• Entrées : TT1 / TT2</text>'
        '<text x="640" y="461" font-size="11" fill="#111">• Actionneur : 24V modulant</text>'
        '<text x="640" y="484" font-size="11" fill="#111">• Sortie : analogique vers YV1</text>'
        ...
        '<text x="30" y="580" font-size="12" fill="#111">Folio commande</text>'
        '<text x="1000" y="580" font-size="12" fill="#111">11</text>'
